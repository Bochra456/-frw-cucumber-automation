 Feature: Verifier le module register
  ...
  @tag2
  Scenario Outline: Création d'un compte à un utilisateur
    ...
    And un message de confirmation est affiché "Thank you for registering. You may now sign-in using the user name and password you've just entered."
